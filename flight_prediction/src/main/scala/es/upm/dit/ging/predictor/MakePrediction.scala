...
object MakePrediction {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // Ruta base dinámica
    val base_path = Paths.get("").toAbsolutePath.toString
    println(s"Base path: $base_path")
    ...
    val stringIndexerModelPath = columns.map(n => s"$base_path/models/string_indexer_model_$n.bin")
